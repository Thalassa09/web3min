        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          <div className="relative flex items-center min-w-0 flex-1 gap-1.5">
            ...
            <button
              ...
              className="hidden sm:flex size-8 shrink-0 items-center justify-center rounded-xl border-2 border-ink-900 bg-white text-choco-900 shadow-[0_2px_0_#3B2218] hover:bg-candy-100 active:translate-y-0.5 transition-all cursor-pointer"
              title="Geser ke kiri"
