...
export const LEADERBOARD_PRIZE_TIERS: PrizeTier[] = [
  ...
  },
  {
    ...
    maxRank: 100,
    coins: 60,
    label: "Peringkat 51 – 100 (Top 100)",
    badge: "🔥 Top 100",
    color: "#10B981",
