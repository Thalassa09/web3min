    ...
    <div className={cn("flex items-center justify-between gap-3 mb-3", className)}>
      <div className="flex flex-col">
        <h3
          ...
          {...rest}
        >
          <span className="inline-flex items-center justify-center size-5 rounded-md bg-candy-100 border border-candy-400 text-candy-600 select-none shadow-[0_1.5px_0_#E8437F]">
