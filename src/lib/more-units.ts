...
function tf(id: string, prompt: string, answer: boolean, explanation: string, blobi?: string): TfExercise {
...
function match(id: string, prompt: string, pairs: { left: string; right: string }[], blobi?: string): MatchExercise {
  return { type: "match", id, prompt, pairs, blobi };
}
function order(id: string, prompt: string, pieces: string[], explanation: string, blobi?: string): OrderExercise {
